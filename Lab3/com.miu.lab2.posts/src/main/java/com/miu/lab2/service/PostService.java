...
public class PostService implements IPostService {
   ...
   public boolean updatePost(PostDto postDto) {
    ...
    @Override
    public List<PostDto> findPostsByTitleIgnoreCase(String title) {
        var posts =  postsRepo.findPostsByTitleIgnoreCase(title);
        var dtoList = new ArrayList<PostDto>();
        posts.forEach(p -> dtoList.add(modelMapper.map(p, PostDto.class)));
        return dtoList;
    }
}
