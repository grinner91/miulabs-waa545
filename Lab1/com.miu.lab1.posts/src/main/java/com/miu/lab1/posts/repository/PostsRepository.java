...
public class PostsRepository implements IPostsRepository {
    ...
    private static List<Post> createPosts() {
        ...
        posts.add(new Post(1, "Post1", "This is 1st content", "Monir Zaman ", new Date()));
        posts.add(new Post(2, "Post12", "This is 2nd content", "Rafsan Zaman ", new Date()));
        posts.add(new Post(3, "Post3", "This is 3rd content", "Monir Zaman ", new Date()));
        posts.add(new Post(4, "Post4", "This is 4th content", "Rafsan Zaman ", new Date()));
